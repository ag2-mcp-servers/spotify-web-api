...
#   timestamp: 2025-06-29T09:50:35+00:00
...
from models import (
    ...
    MeShowsGetResponse,
    MeShowsPutResponse,
    MeTopTypeGetResponse,
    MeTopTypeGetResponse1,
...
Optional parameters can be used to limit the number of tracks returned.
 """,
    tags=['album_management', 'track_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
def get_an_albums_tracks(
    ...
    limit: Optional[conint(ge=0, le=50)] = 20,
...
@app.get(
 ...
 """,
    tags=['artist_management', 'user_artist_following'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
**Note: Audiobooks are only available for the US, UK, Ireland, New Zealand and Australia markets.**
 """,
    tags=['audiobook_management', 'user_audiobook_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.get(
 ...
 """,
    tags=['category_exploration', 'playlist_operations'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.get(
 ...
 """,
    tags=['show_management', 'user_show_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
unique Spotify ID.
 """,
    tags=['show_management', 'user_episode_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.get(
 ...
 """,
    tags=['category_exploration', 'search_functionality'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
def get_users_saved_audiobooks(
    limit: Optional[conint(ge=0, le=50)] = 20, offset: Optional[int] = 0
):
    """
...
@app.delete(
 ...
 """,
    tags=['user_episode_management', 'user_profile_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.delete(
 ...
 """,
    tags=['user_artist_following', 'user_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
def get_followed(
    type: Type13, after: Optional[str] = None, limit: Optional[conint(ge=0, le=50)] = 20
):
    """
...
@app.get(
 ...
 """,
    tags=['user_playback_state', 'user_playback_control'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.put(
 ...
 """,
    tags=['user_playback_control', 'user_playback_state'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.get(
 ...
 """,
    tags=['user_queue_management', 'user_profile_management', 'user_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.post(
 ...
 """,
    tags=['user_queue_management', 'user_playback_control'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
_**Note**: Currently doesn't support podcast episodes._
 """,
    tags=['user_management', 'track_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
user.
 """,
    tags=['user_playlist_management', 'playlist_operations'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.delete(
 ...
 """,
    tags=['user_show_management', 'user_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
def remove_shows_user(ids: str, market: Optional[str] = None):
    """
...
@app.delete(
 ...
 """,
    tags=['user_profile_management', 'user_management', 'track_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.put(
 ...
 """,
    tags=['track_management', 'user_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.get(
 ...
 """,
    tags=['playlist_operations', 'user_playlist_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.put(
 ...
 """,
    tags=['user_playlist_management', 'playlist_operations', 'user_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
For artists and tracks that are very new or obscure there might not be enough data to generate a list of tracks.
 """,
    tags=['recommendation_system', 'track_analysis'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.get(
 ...
 """,
    tags=['recommendation_system', 'category_exploration'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.get(
 ...
 """,
    tags=['user_show_management', 'show_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
@app.get(
 ...
 """,
    tags=['track_management', 'artist_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
    ],
)
...
def get_list_users_playlists(
    user_id: str, limit: Optional[conint(ge=0, le=50)] = 20, offset: Optional[int] = 0
):
    """
