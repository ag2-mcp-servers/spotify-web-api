...
class MePlayerDevicesGetResponse1(BaseModel):
    error: ErrorObject
...
class MePlayerPlayPutRequest(BaseModel):
    ...
    position_ms: Optional[int] = Field(None, description='integer')
...
class MeTopTypeGetResponse1(BaseModel):
    error: ErrorObject
...
class Type20(RootModel[List[TypeEnum]]):
...
class AlbumBase(BaseModel):
    ...
    label: Optional[str] = Field(
        None, description='The label associated with the album.\n'
    )
    name: str = Field(
        ...,
...
class ArtistObject(BaseModel):
    ...
    type: Literal['ArtistObject'] = Field(..., description='The object type.\n')
    uri: Optional[str] = Field(
        None,
        description='The [Spotify URI](/documentation/web-api/#spotify-uris-and-ids) for the artist.\n',
    )
...
class TrackObject(BaseModel):
    ...
    linked_from: Optional[Dict[str, Any]] = Field(
        None,
...
class Items(RootModel[Union[ArtistObject, TrackObject]]):
    root: Union[ArtistObject, TrackObject] = Field(..., discriminator='type')


class MeTopTypeGetResponse(PagingObject):
